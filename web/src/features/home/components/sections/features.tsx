        ...
        <div className='mt-4 overflow-hidden rounded-lg border border-amber-500/20 bg-amber-500/[0.04]'>
          ...
          {PRICE_ROWS.map((row, i) => (
            ...
            >
              ...
              <span className='text-muted-foreground/70 text-right line-through'>
                {row.official}
              </span>
      ...
      visual: (
        <div className='mt-4 flex items-center justify-center'>
          <div className='relative flex size-20 items-center justify-center'>
            ...
            />
            <div className='relative flex size-12 items-center justify-center rounded-full border border-emerald-500/40 bg-emerald-500/10 text-[11px] font-bold text-emerald-600 tabular-nums dark:text-emerald-400'>
              85%
            </div>
          </div>
        </div>
